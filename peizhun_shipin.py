...
cap = cv2.VideoCapture('F:/ygszfx/lanxiumei/lxm/20220606-lxm-whq-1-jianduan.mp4')
...
out = cv2.VideoWriter('F:/ygszfx/lanxiumei/lxm/20220606-lxm-whq-1-jianduan-qudou1.mp4', fourcc, fps, (w, h))
# Read first frame
_, prev = cap.read()
...
for i in range(n_frames-2):
  ...
  if(frame_out.shape[1] > 1920): 
    frame_out = cv2.resize(frame_out, (int(frame_out.shape[1]/2), int(frame_out.shape[0]/2)),interpolation = cv2.INTER_AREA)
